            ...
            <div class="col-md-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h2 class="text-bold text-info"><strong>Add New Course</strong></h2>
                    </header>
                    <div class="panel-body" style="background-color: #eeeeee">
                        <form  id="saveCourse" action="../Auth/saveNewCourse.php" method="post" class="form-horizontal">
                            ...
                            <button name="saveCourse" id="saveNewCourse" type="submit" class="btn btn-info btn-default ">
